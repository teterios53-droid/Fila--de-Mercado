...
// SERVIR TODA A PASTA DO PROJETO
...
wss.on("connection", (ws)=>{
  ...
  ws.on("message", (msg)=>{
    try{
      ...
      // RECONEXÃO CLIENTE
      if(data.tipo==="reconectar"){ send(ws, {tipo:"atualizacao", fila, historico}); return; }
      ...
      // CANCELAR SENHA ESPECÍFICA ATENDENTE
